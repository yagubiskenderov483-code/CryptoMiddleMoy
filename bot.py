...
LANGS = {
    "ru": {
        ...
        "deal_created": (
            ...
            "1️⃣ Продавец передаёт актив менеджеру: <b>@hostelman</b>\n"
            "2️⃣ Менеджер проверяет получение в течение <b>5 минут</b>\n"
            "3️⃣ После подтверждения покупатель отправляет оплату\n"
            "4️⃣ Менеджер верифицирует оплату и передаёт актив покупателю\n\n"
            "⚠️ Никогда не передавайте активы напрямую — только через @hostelman\n"
        ...
        "deal_info": (
            ...
            "3️⃣ Покупатель отправляет оплату\n"
            "4️⃣ Менеджер верифицирует и закрывает сделку\n\n"
            "⚠️ Передавайте активы только через @hostelman\n"
